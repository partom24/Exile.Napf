...
_serverRestartTime 	= parseNumber ExileServerRestartTime;
//format["[ExileServerRestartTime]%1", _serverRestartTime] call ExileServer_util_log;
_correcTime		= [];
{
...
//[1 hour = 60,2 hour = 120,3 hour = 180,4 hour = 240,5 hour = 300,6 hour = 360,7 hour = 420,8 hour = 480,9 hour = 540,10 hour = 600,11 hour = 660,12 hour = 720]
_hours = (floor(_time/60));
_minutes = (_time - (_hours * 60));

_daytime = daytime;
_dayhours = floor _daytime;
_dayminutes = floor((_daytime - _dayhours) * 60);
...
switch (_dayminutes) do
{
	case 9: {_dayminutes = "09"};
	case 8: {_dayminutes = "08"};
	case 7: {_dayminutes = "07"};
	case 6: {_dayminutes = "06"};
	case 5: {_dayminutes = "05"};
	case 4: {_dayminutes = "04"};
	case 3: {_dayminutes = "03"};
	case 2: {_dayminutes = "02"};
	case 1: {_dayminutes = "01"};
	case 0: {_dayminutes = "00"};
};
...
<t shadow='1' shadowColor='#000000' size='1.1' color='%10'><img size='1.1'  shadowColor='#000000' image='Custom\StatusBar\Icons\locker.paa' color='%10'/> %19  </t>
...
<t shadow='1' shadowColor='#000000' size='1.1' color='%10'><img size='1.1'  shadowColor='#000000' image='Custom\StatusBar\Icons\clock.paa' color='%10'/> %17:%18  </t>
