...
"Thomas's Random Loadout" call ExileServer_util_log;
_requestingPlayer = _sessionID call ExileServer_system_session_getPlayerObject;
private _randomLoadout = call ThomasCustom_random_loadout_selector;
try
{
	...
	removeHeadgear _bambiPlayer;
	{
		...
		switch (_cargoType) do
		{
			...
			case 3: 	{ _bambiPlayer addBackpack _x;};
			case 4:		{ _bambiPlayer linkItem _x;};
			case 5: 	{ _bambiPlayer addVest _x;};
			case 6: 	{ _bambiPlayer addHeadgear _x;};
			case 7: 	{ _bambiPlayer addUniform _x;};
			default 	{ _bambiPlayer addItem _x;};
		};
	}
	//forEach getArray(configFile >> "CfgSettings" >> "BambiSettings" >> "loadOut");
	forEach _randomLoadout;
