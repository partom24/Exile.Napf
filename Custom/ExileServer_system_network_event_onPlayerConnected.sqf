...
{
	_message = format["Player %1 connected. :)", _name];
	["success", "message", [_message]] call ESM_fnc_logToDiscord;
	format["[Overwright]::Player %1 (UID %2) connected!", _name, _uid] call ExileServer_util_log;	
